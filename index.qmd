...
colorado_bar = plt.Rectangle((0, 0), 1, 1, color="darkorchid", label="Colorado Rockies")
other_bar = plt.Rectangle((0, 0), 1, 1, color="lightgrey", label="Other Stadiums")
axes[0].legend(handles=[colorado_bar, other_bar], loc='lower right', fontsize=7, frameon=True)
...
axes[1].legend(handles=[colorado_bar, other_bar], loc='lower right', fontsize=7, frameon=True)
